...
JS_INPUT = os.path.join(SRC_DIR, "neiki-qr.js")
CSS_INPUT = os.path.join(SRC_DIR, "neiki-qr.css")

JS_OUTPUT = os.path.join(OUTPUT_DIR, "neiki-qr.js")
JS_MIN_OUTPUT = os.path.join(OUTPUT_DIR, "neiki-qr.min.js")
JS_MIN_TEMP = os.path.join(OUTPUT_DIR, "neiki-qr.min.temp.js")
CSS_OUTPUT = os.path.join(OUTPUT_DIR, "neiki-qr.css")
CSS_MIN_OUTPUT = os.path.join(OUTPUT_DIR, "neiki-qr.min.css")

BANNER = "/* neiki-qr 1.0.0 | MIT */\n"
...
def embed_css(js_source, css_text):
    if CSS_MARKER not in js_source:
        raise RuntimeError("Could not find EMBEDDED_CSS marker in src/neiki-qr.js")
...
def main():
    ...
    if not minified_js.startswith("/* neiki-qr"):
